...
write.csv(var_sim_df,
          file = file.path(getwd(), "data", "inputs", "gaussian_var_large_n_sim0.csv"),
          row.names = FALSE)
...
write.csv(var_sim_shifted_df,
          file = file.path(getwd(), "data", "inputs", "gaussian_var_large_n_sim1.csv"),
          row.names = FALSE)
...
write.csv(var_sim_shifted_df2,
          file = file.path(getwd(), "data", "inputs", "gaussian_svar_large_n_sim0.csv"),
          row.names = FALSE)
