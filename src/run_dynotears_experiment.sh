...
python run_pipeline.py --fs_method dynotears --clustering_method rolling_kmenas --n_clusters 0
python run_pipeline.py --fs_method dynotears --clustering_method rolling_kmenas --n_clusters 5
python run_pipeline.py --fs_method dynotears --clustering_method rolling_kmenas --n_clusters 10